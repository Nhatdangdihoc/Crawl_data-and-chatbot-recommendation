...
headers = {
    ...
    "dnt": "1",
    "referer": "https://tiki.vn/search?q=qu%E1%BA%A7n%20d%C3%A0i%20nam",
...
with open('quan_dai_nam_id.csv', mode='w', newline='', encoding='utf-8') as file:
...
print("Đã lưu các ID sản phẩm vào file quan_dai_nam_id.csv")
