...
df_ids = pd.read_csv("./Quần jogger nam/quan_jogger_nam_id.csv")
...
df_products.to_csv('data_quan_jogger_nam.csv', index=False, encoding='utf-8-sig')

print("Dữ liệu đã được lưu vào file data_jogger.csv.")
