...
df_ids = pd.read_csv("./Váy dài/vay_dai_id.csv")
...
df_products.to_csv('data_vay_dai.csv', index=False, encoding='utf-8-sig')
print("Dữ liệu đã được lưu vào file data_vay_dai.csv.")
