...
df_ids = pd.read_csv("./Quần thể thao nữ/quan_the_thao_nu_id.csv")
...
df_products.to_csv('./Quần thể thao nu/data_quan_the_thao_nu.csv', index=False, encoding='utf-8-sig')
print("Dữ liệu đã được lưu vào file data_quan_the_thao_nu.csv.")
