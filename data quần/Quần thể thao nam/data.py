...
df_ids = pd.read_csv("./Quần thể thao nam/quan_the_thao_nam_id.csv")
...
df_products.to_csv('./Quần thể thao nam/data_quan_the_thao_nam.csv', index=False, encoding='utf-8-sig')
print("Dữ liệu đã được lưu vào file data_quan_the_thao_nam.csv.")
