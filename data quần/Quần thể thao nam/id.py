...
# Mở file CSV để ghi
with open('./Quần thể thao nam/quan_the_thao_nam_id.csv', mode='w', newline='', encoding='utf-8') as file:
...
print("Đã lưu các ID sản phẩm vào file quan_the_thao_nam_id.csv")
