...
df_ids = pd.read_csv("./Quần dài nữ/quan_dai_nu_id.csv")
...
df_products.to_csv('data_quan_dai_nu.csv', index=False, encoding='utf-8-sig')

print("Dữ liệu đã được lưu vào file data_quan_dai_nu.csv.")
