...
df_ids = pd.read_csv("./Quần tất nữ/quan_tat_nu_id.csv")
...
df_products.to_csv('./Quần tất nữ/data_quan_tat_nu.csv', index=False, encoding='utf-8-sig')
print("Dữ liệu đã được lưu vào file data_quan_tat_nu.csv.")
