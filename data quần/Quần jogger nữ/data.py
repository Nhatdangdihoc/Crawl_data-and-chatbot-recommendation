...
df_ids = pd.read_csv("./Quần jogger nữ/quan_jogger_nu_id.csv")
...
df_products.to_csv('./Quần jogger nữ/data_quan_jogger_nu.csv', index=False, encoding='utf-8-sig')

print("Dữ liệu đã được lưu vào file data_jogger_nu.csv.")
